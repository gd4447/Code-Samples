...
"""
Created on Fri Jan 18 11:24:30 2020

@author: Gerardo

This script generates an "Activity Report" that many clients have requested on a weekly basis. 
All you need to do is run the script and all the reports will appear on your specified path.
...
#SQL PARAMETERS - Automatically pick Monday thru Sunday for dates
...
def get_data(start,end,client,username,pw):
    ...
    WHERE a.DateUtc BETWEEN '{}' AND '{}'
        AND e.recordsEventType IN (Event List (Anonymized))
